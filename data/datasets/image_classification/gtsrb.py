from ..data_aug import cifar_like_image_train_aug, cifar_like_image_test_aug, imagenet_like_image_test_aug, imagenet_like_image_train_aug
...
class GTSRB(ABDataset):    
    def create_dataset(self, root_dir: str, split: str, transform: Optional[Compose], 
        ...
        dataset = ImageFolder(os.path.join(root_dir, 'Final_Training/Images/') if split != 'test' else os.path.join(root_dir, 'Final_Test_ImageFolder/'), transform=transform)
