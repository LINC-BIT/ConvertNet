...
class Opus_books_taskbase(Dataset):
...
class Opus_books(ABDataset):    
    def create_dataset(self, root_dir: str, split: str, transform, 
                       classes: List[str], ignore_classes: List[str], idx_map: Optional[Dict[int, int]]):
        return Opus_books_taskbase(root_dir, split, transform, classes, ignore_classes, idx_map)

# a = Opus_books_taskbase('/data/zql/datasets/opus_books', 'train', None, None, None, None)
# a.__getitem__(0)